 ...
 */
native give_artifact(pPlayer, iCount);

#pragma semicolon 1
#pragma compress 1

public stock const PluginName[] = "[VipM-I] Artifact";
public stock const PluginVersion[] = "1.0.0";
public stock const PluginAuthor[] = "ArKaNeMaN";
public stock const PluginURL[] = "t.me/arkanaplugins";
public stock const PluginDescription[] = "[VipM-I] Support for CHEL74's Artifact";

new const TYPE_NAME[] = "Artifact";
...
@OnGive(const UserId, const Trie:tParams) {
    return give_artifact(UserId, VipM_Params_GetInt(tParams, "Count", 1))
        ? VIPM_CONTINUE
        : VIPM_STOP;
}